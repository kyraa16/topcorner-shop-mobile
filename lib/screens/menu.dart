...
import 'package:topcorner_shop/widgets/product_card.dart';
...
class MyHomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        // Judul aplikasi "Top Corner Shop" dengan teks putih dan tebal.
        title: const Text(
          'Top Corner Shop',
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Padding(
                    ...
                    child: Text(
                      'Selamat datang di Top Corner Shop',
                      style: TextStyle(
...
class ItemHomepage {
  ...
  ItemHomepage(this.name, this.icon, this.color, {this.onTap});
}
